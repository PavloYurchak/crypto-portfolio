...
public partial class CryptoPorfolioContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasIndex(e => new { e.UserId, e.AssetId, e.CurrencyId }, "IXU_UserAssets_UserId_AssetId_CurrencyId")
                .IsUnique()
                .HasFilter("[DeletedAt] IS NULL");
            ...
            entity.HasOne(d => d.Currency).WithMany(p => p.UserAssets)
                .HasForeignKey(d => d.CurrencyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UserAssets_Currencies_Id");
        });
